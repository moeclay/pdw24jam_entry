    ...
    <nav class="navbar navbar-static-top">
      <div class="container">
        ...
        <div class="navbar-header">
          <a href="<?php echo site_url('koperasi');?>" class="navbar-brand"><b><?php echo config_item('web_title'); ?></b></a>
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            <li><a href="<?php echo site_url('koperasi');?>">Input Kinerja</a></li>
            <li class="dropdown ">
      ...
      <form class="form-horizontal" action="#" method="post">
        <div class="panel panel-default">
          <div class="panel-body">
            <!--code here-->
            <h5><i class="fa fa-laptop"> </i> <b>Data Kinerja &nbsp; <?php echo $view_idkinerja; ?></b> <span class="pull-right" style="margin-top: -8px;"><button title="Print" type="button" class="btn btn-warning btn-sm"  onclick="printData('report_invoice')"><i class="fa fa-print"> Print Data </i></button><span></h5>
            <hr>
            <div class="row">
               <div class="col-xs-12 col-md-12">
                <!-- kontent here-->
