    ...
    <nav class="navbar navbar-static-top">
      <div class="container">
        ...
        <div class="navbar-header">
          <a href="<?php echo site_url('koperasi');?>" class="navbar-brand"><b>KOPERASI KARYAWAN</b></a>
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            <li><a href="<?php echo site_url('koperasi');?>">Input Koperasi</a></li>
            <li><a href="<?php echo site_url('koperasi/home/laporan');?>">Laporan</a></li>
            <li class="dropdown ">
