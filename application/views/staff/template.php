      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            ?>
              <li><a href="<?php echo site_url('staff/home/mutasi');?>"><i class="fa fa-money" aria-hidden="true"></i> Mutasi Bank</a></li>
            <?php } ?>
            <li class="dropdown ">
              ...
              <ul class="dropdown-menu" role="menu">
                <li><a href="<?php echo site_url('user/keluar');?>"> Keluar</a></li>
              </ul>
            </li>
          </ul>          
        </div>
