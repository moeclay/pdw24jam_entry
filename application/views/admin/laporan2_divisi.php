...
<head>
    ...
    <script type="text/javascript">
        ...
        async function getData4(){
            let result1 = await fetch("http://192.168.4.25/entry/admin/laporan/kalkulasidivisi");
            ...
            for(var i=0; i<panjang; i++){
                ...
                datadivisi += "<tr><td>"+result.divisi[i].nama_divisi.toUpperCase()+"</td><td>"+ontime.toFixed(1)+"% </td><td>"+hijau.toFixed(1)+" %</td><td>"+kuning.toFixed(1)+"%</td><td>"+merah.toFixed(1)+"%</td><td>"+ungu.toFixed(1)+"%</td></tr>";
            }
      ...
      <?php } ?>
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <div class="box box-danger">
                    ...
                    <div class="box-body">
                          ...
                          <li><a class="active" href="<?php echo site_url('admin/laporan/divisi');?>"><i class="fa fa-calendar-o" aria-hidden="true"></i>&nbsp;&nbsp;Dept/Div</a></li>
            ...
            <div class="col-md-10">
                ...
                <!-- start of personal keseluruhan -->
                <div class="row">
                    <div class="col-md-12">
                        <div class="box box-danger">
                            <div class="box-header">
                                <!-- data personal kinerja produksi keseluruhan -->
                                <p><b>Deparment | Kinerja</b></p>
                            </div>
