<table class="table">
                <thead>
                  ...
                  <tr>
                    ...
                    <th class="text-center" title="Durasi waktu dari (input -> selesai)">PROSES</th>
                    <th class="text-center" title="Durasi waktu dari (selesai -> diambil)">KE KONSUMEN</th>
                    <th class="text-center" title="Durasi waktu dari (commit -> input)">KOMIT</th>
