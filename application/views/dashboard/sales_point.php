...
<head>
    ...
    <script type="text/javascript">
        ...
        async function getData4(){
            let result1 = await fetch("http://localhost/entry/admin/laporan/kalkulasisales");
            ...
            for(var i=0; i<panjang; i++){
                ...
                datasales += "<tr><td>"+result.personal[i].nama.toUpperCase()+" <small>("+result.personal[i].nama_divisi+")</small> "+"</td><td class='text-center' style='font-size: 12px;'>"+ontime+"</td><td class='text-center' style='font-size: 12px;'>"+hijau+"</td><td class='text-center' style='font-size: 12px;'>"+kuning+"</td><td class='text-center' style='font-size: 12px;'>"+merah+"</td><td class='text-center' style='font-size: 12px;'>"+ungu+"</td><td class='text-center bg-danger' style='font-size: 12px; border-left: 1px solid #333;'><b>"+total_telat+"</b></td><td class='text-center bg-info' style='font-size: 12px; border-left: 1px solid #333; border-right: 1px solid #333;'><b>"+bonus+"</b></td></tr>";
            }
            document.getElementById("datasales").innerHTML = datasales;
            ...
            <div class="col-md-12">
                    <div class="box box-success">
                        <div class="box-header">
                            ...
                            <p class='text-center'><b>SALES POINT | KINERJA</b></p>
                        </div>

                        <div class="box-body">
                            <div class="chart-container">
                                <table class="table table-striped table-responsive" id="sales">
                                    <thead>
                                        <tr>
                                            <th>Operator Sales</th>
                                            ...
                                            <th class='text-center'>Point &#62;60Menit</th>
                                            <th class='text-center'>Point Telat</th>
                                            <th class='text-center'>Selisih Point</th>
                                        </tr>
                                    </thead>
                                    <tbody id="datasales"></tbody>
                                </table>
                            </div>
                        </div>
                        <!-- end of box-body-->
