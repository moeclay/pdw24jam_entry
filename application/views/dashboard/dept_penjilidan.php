...
<head>
    ...
    <script type="text/javascript">
        ...
        async function getData4(){
            ...
            var panjang = result.kinerja_penjilidan.length.toString();
            
            
            let datapengerjaan = "";
            for(var i=0; i<panjang; i++){
                // master 1
                nama   = result.kinerja_penjilidan[i].nama.toUpperCase();
                totalpersonal = result.kinerja_penjilidan[i].total_personal;
                ontime = parseInt(result.kinerja_penjilidan[i].total_putih)/parseInt(totalpersonal)*100;
                hijau  = parseInt(result.kinerja_penjilidan[i].total_hijau)/parseInt(totalpersonal)*100;
                kuning = parseInt(result.kinerja_penjilidan[i].total_kuning)/parseInt(totalpersonal)*100;
                merah  = parseInt(result.kinerja_penjilidan[i].total_merah)/parseInt(totalpersonal)*100;
                ungu   = parseInt(result.kinerja_penjilidan[i].total_ungu)/parseInt(totalpersonal)*100;
                selisih = parseFloat(result.kinerja_penjilidan[i].selisih);
            ...
            document.getElementById("datapengerjaanpenjilidan").innerHTML = datapengerjaan;

            // datatable
            $('#pengerjaanpenjilidan').DataTable({
                paging: false,
                searching: false,
                order: [[ 1, "desc" ]]
            });
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?= site_url('admin/laporan2/dept_penjilidan'); ?>"><i class="fa fa-circle-o"></i> PENJILIDAN</a></li>
            ...
            <div class="col-md-12">
                <div class="box box-success">
                    <div class="box-header">
                        <p class='text-center'><b>Penjilidan | Kinerja Department</b></p>
                    </div>
                    <div class="box-body">
                        <div class="chart-container">
                            <table class="table table-striped table-responsive" id="pengerjaanpenjilidan">
                                <thead>
                                    <tr>
                                ...
                                <tbody id="datapengerjaanpenjilidan"></tbody>
                            </table>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="box-body">
                                            ...
                                            <script type="text/javascript">
                                                ...
                                                async function hello3() {
                                                    ...
                                                    var total   = parseInt(result.grafik_penjilidan[0].total_divisi);
                                                    var ontime  = parseInt(result.grafik_penjilidan[0].total_ontime);
                                                    var offtime = parseInt(result.grafik_penjilidan[0].total_offtime);
                                        ...
                                        <div class="box-body">
                                            ...
                                            <script type="text/javascript">
                                                ...
                                                async function hello2() {
                                                    ...
                                                    var total   = parseInt(result.grafik_penjilidan[0].total_divisi);
                                                    var putih   = parseInt(result.grafik_penjilidan[0].total_ontime);
                                                    var hijau   = parseInt(result.grafik_penjilidan[0].total_hijau);
                                                    var kuning  = parseInt(result.grafik_penjilidan[0].total_kuning);
                                                    var merah   = parseInt(result.grafik_penjilidan[0].total_merah);
                                                    var ungu    = parseInt(result.grafik_penjilidan[0].total_ungu);
