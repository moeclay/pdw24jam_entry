...
<head>
    ...
    <script type="text/javascript">
        ...
        async function getData4(){
            let result1 = await fetch("http://entry.org/admin/laporan/kalkulasibulan");
            ...
            for(var i=0; i<panjang; i++){
                ...
                datapengerjaan += "<tr><td>"+result.bulan[i].tahun+"</td><td>"+result.bulan[i].bulan_title.toUpperCase()+"</td><td class='text-center'>"+ontime.toFixed(1)+"% </td><td class='text-center'>"+hijau.toFixed(1)+" %</td><td class='text-center'>"+kuning.toFixed(1)+"%</td><td class='text-center'>"+merah.toFixed(1)+"%</td><td class='text-center'>"+ungu.toFixed(1)+"%</td></tr>";
            }
   ...
   <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="<?= site_url('admin/laporan2/bulan'); ?>"><i class="fa fa-calendar" aria-hidden="true"></i> <span>BULAN</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
   </aside>
            ...
            <div class="col-md-12">
                    <div class="box box-success">
                        <div class="box-header">
                            ...
                            <p class='text-center'><b>Bulan | Kinerja</b></p>
                        </div>
