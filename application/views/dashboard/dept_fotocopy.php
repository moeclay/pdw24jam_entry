...
<head>
    ...
    <script type="text/javascript">
        ...
        async function getData4(){
            ...
            var panjang = result.kinerja_fotocopy.length.toString();
            
            
            let datapengerjaan = "";
            for(var i=0; i<panjang; i++){
                // master 1
                nama   = result.kinerja_fotocopy[i].nama.toUpperCase();
                totalpersonal = result.kinerja_fotocopy[i].total_personal;
                ontime = parseInt(result.kinerja_fotocopy[i].total_putih)/parseInt(totalpersonal)*100;
                hijau  = parseInt(result.kinerja_fotocopy[i].total_hijau)/parseInt(totalpersonal)*100;
                kuning = parseInt(result.kinerja_fotocopy[i].total_kuning)/parseInt(totalpersonal)*100;
                merah  = parseInt(result.kinerja_fotocopy[i].total_merah)/parseInt(totalpersonal)*100;
                ungu   = parseInt(result.kinerja_fotocopy[i].total_ungu)/parseInt(totalpersonal)*100;
                selisih = parseFloat(result.kinerja_fotocopy[i].selisih);
            ...
            document.getElementById("datapengerjaanfotocopy").innerHTML = datapengerjaan;

            // datatable
            $('#pengerjaanfotocopy').DataTable({
                paging: false,
                searching: false,
                order: [[ 1, "desc" ]]
            });
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?= site_url('admin/laporan2/dept_fotocopy'); ?>"><i class="fa fa-circle-o"></i> FOTOCOPY</a></li>
            ...
            <div class="col-md-12">
                <div class="box box-success">
                    <div class="box-header">
                        <p class='text-center'><b>Fotocopy | Kinerja Department</b></p>
                    </div>
                    <div class="box-body">
                        <div class="chart-container">
                            <table class="table table-striped table-responsive" id="pengerjaanfotocopy">
                                <thead>
                                    <tr>
                                ...
                                <tbody id="datapengerjaanfotocopy"></tbody>
                            </table>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="box-body">
                                            ...
                                            <script type="text/javascript">
                                                ...
                                                async function hello3() {
                                                    ...
                                                    var total   = parseInt(result.grafik_fotocopy[0].total_divisi);
                                                    var ontime  = parseInt(result.grafik_fotocopy[0].total_ontime);
                                                    var offtime = parseInt(result.grafik_fotocopy[0].total_offtime);
                                        ...
                                        <div class="box-body">
                                            ...
                                            <script type="text/javascript">
                                                ...
                                                async function hello2() {
                                                    ...
                                                    var total   = parseInt(result.grafik_fotocopy[0].total_divisi);
                                                    var putih   = parseInt(result.grafik_fotocopy[0].total_ontime);
                                                    var hijau   = parseInt(result.grafik_fotocopy[0].total_hijau);
                                                    var kuning  = parseInt(result.grafik_fotocopy[0].total_kuning);
                                                    var merah   = parseInt(result.grafik_fotocopy[0].total_merah);
                                                    var ungu    = parseInt(result.grafik_fotocopy[0].total_ungu);
